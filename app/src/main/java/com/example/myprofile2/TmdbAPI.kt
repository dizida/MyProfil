...
interface TmdbAPI {
    ...
    @GET("search/tv")
    suspend fun getSeriesParMotCle(@Query("api_key") apiKey: String, @Query("query") motcle: String): TmdbResultSerie

    @GET("search/person")
    suspend fun getActorsParMotCle(@Query("api_key") apiKey: String, @Query("query") motcle: String): TmdbResultActors

    @GET("trending/movie/week")
    suspend fun getTrendingMovies(@Query("api_key") apiKey: String): TmdbResult

    @GET("trending/tv/week")
    suspend fun discoverSeries(@Query("api_key") apiKey: String, @Query("query") sortBy: String = "popularity.desc"): TmdbResultSerie
